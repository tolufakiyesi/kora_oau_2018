...
public class CreditFragment extends android.app.Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState){
        ...
        if(allMyTransactions.isEmpty()){
            ...
            RecyclerView recyclerView = getView().findViewById(R.id.display_all_credits);
            recyclerView.setHasFixedSize(true);
            recyclerView.setLayoutManager(new LinearLayoutManager(getActivity()));
            TransactionAdapter adapter = new TransactionAdapter(getActivity().getApplicationContext(), allMyTransactions, Color.GREEN, false);
